    ...
    HomePage(
        ...
        header = {
            HeaderDesign(
                ...
                title = {
                    Text(text = stringResource(R.string.store_location),
                        style = TextStyle(
                            fontSize = 12.sp,
                        )
                    )
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(text = stringResource(R.string.mondolibug_sylhet),
                            style = TextStyle(
                                fontSize = 14.sp,
                ...
                leadingIcon = {
                    CustomIcon(icon = R.drawable.menu, contentDescription = stringResource(R.string.menu)) {
                        //TODO menu button action here
                    }
                }, trailingIcon = {
                    CustomIcon(icon = R.drawable.bag, contentDescription = stringResource(R.string.bag)) {
                        //TODO menu button action here
                    }
                }
            )
